...
/* global Reflect, Promise */
        ...
        function __asyncGenerator(thisArg, _arguments, generator) {
            ...
            return i = {}, verb("next"), verb("throw"), verb("return"), i[Symbol.asyncIterator] =
                function() { return this; }, i;

            function verb(n) {
                if (g[n])
                    i[n] = function(v) {
                        return new Promise(function(a, b) { q.push([n, v, a, b]) > 1 || resume(n, v); });
                    };
            }
        ...
        function __asyncDelegator(o) {
            var i, p;
            return i = {}, verb("next"), verb("throw", function(e) { throw e; }), verb("return"), i[Symbol.iterator] =
                function() { return this; }, i;
                ...
                DefaultHttpClient.prototype.send = function(request) {
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        xhr.onerror = function() {
                            _this.logger.log(ILogger.LogLevel.Warning,
            ...
            var HandshakeProtocol = /** @class */ (function() {
                ...
                HandshakeProtocol.prototype.parseHandshakeResponse = function(data) {
                    ...
                    if (data instanceof ArrayBuffer) {
                        ...
                        var separatorIndex =
                            binaryData.indexOf(TextMessageFormat_1.TextMessageFormat.RecordSeparatorCode);
                        if (separatorIndex === -1) {
                            throw new Error("Message is incomplete.");
                        }
                        ...
                        return tslib_1.__generator(this,
                            function(_b) {
                                ...
                                case 1:
                                    ...
                                    logger.log(ILogger.LogLevel.Trace,
                                        "(" +
                                        transportName +
...
/** Represents a connection to a SignalR Hub. */
            var HubConnection = /** @class */ (function() {
                        ...
                        function() {
                            ...
                            return tslib_1.__generator(this,
                                function(_a) {
                                    ...
                                    case 2:
                                        _a.sent();
                                        this.logger.log(ILogger.LogLevel.Information,
                ...
                HubConnection.prototype.processHandshakeResponse = function(data) {
                    ...
                    var remainingData;
                    try {
                        _a = this.handshakeProtocol.parseHandshakeResponse(data), remainingData =
                            _a[0], responseMessage = _a[1];
                    } catch (e) {
                ...
                HubConnection.prototype.configureTimeout = function() {
                    ...
                    if (!this.connection.features || !this.connection.features.inherentKeepAlive) {
                        ...
                        this.timeoutHandle = setTimeout(function() { return _this.serverTimeout(); },
                ...
                HubConnection.prototype.invokeClientMethod = function(invocationMessage) {
                    ...
                    if (methods) {
                        ...
                        this.logger.log(ILogger.LogLevel.Warning,
                ...
                HubConnection.prototype.connectionClosed = function(error) {
                    ...
                    Object.keys(callbacks)
                        .forEach(function(key) {
                            ...
                            callback(undefined,
                                error ? error : new Error("Invocation canceled due to connection being closed."));
                        });
                    this.cleanupTimeout();
...
// Not exported from 'index', this type is internal.
            var LongPollingTransport = /** @class */ (function() {
                ...
                Object.defineProperty(LongPollingTransport.prototype,
                    "pollAborted",
                    {
                            ...
                            return tslib_1.__generator(this,
                                function(_a) {
                                    ...
                                    case 1:
                                        ...
                                        this.logger.log(ILogger.LogLevel.Trace,
                                            "(LongPolling transport) polling: " + pollUrl);
                                        return [4 /*yield*/, this.httpClient.get(pollUrl, pollOptions)];
                                    case 2:
                                        response = _a.sent();
                                        if (response.statusCode !== 200) {
                                            this.logger.log(ILogger.LogLevel.Error,
                                ...
                                function(_a) {
                                        ...
                                        if (response.statusCode === 204) {
                                            ...
                                            if (response.content) {
                                                this.logger.log(ILogger.LogLevel.Trace,
                                                    ...
                                                    Utils.getDataDetail(response.content, this.logMessageContent));
                                                if (this.onreceive) {
                                    ...
                                    case 5:
                                        ...
                                        if (!this.running) {
                                            ...
                                            this.logger.log(ILogger.LogLevel.Trace,
                                                "(LongPolling transport) Poll errored after shutdown: " + e_1.message);
                                        } else {
                                    ...
                                    case 8:
                                        ...
                                        if (this.onclose) {
                                            this.logger.log(ILogger.LogLevel.Trace,
                                                "(LongPolling transport) Firing onclose event. Error: " +
                                                (closeError || "<undefined>"));
                                            this.onclose(closeError);
                                        }
                                        this.logger.log(ILogger.LogLevel.Trace,
                                            "(LongPolling transport) Transport finished.");
                                        return [7 /*endfinally*/];
                                    case 9:
                                        return [2 /*return*/];
                                    }
                                            ...
                                            2 /*return*/, new Promise(function(resolve, reject) {
                                                ...
                                                try {
                                                    eventSource.onmessage = function(e) {
                                                        if (_this.onreceive) {
                                                            try {
                                                                _this.logger.log(ILogger.LogLevel.Trace,
                                                                    "(SSE transport) data received. " +
                                                                    Utils.getDataDetail(e.data,
                                                    ...
                                                    eventSource.onopen = function() {
                                                        _this.logger.log(ILogger.LogLevel.Information,
                                            ...
                                            2 /*return*/, new Promise(function(resolve, reject) {
                                                ...
                                                webSocket.onmessage = function(message) {
                                                    _this.logger.log(ILogger.LogLevel.Trace,
                                                        ...
                                                        Utils.getDataDetail(message.data, _this.logMessageContent) +
                                                        ".");
                                                    if (_this.onreceive) {
                ...
                WebSocketTransport.prototype.send = function(data) {
                    if (this.webSocket && this.webSocket.readyState === WebSocket.OPEN) {
                        this.logger.log(ILogger.LogLevel.Trace,
                            ...
                            Utils.getDataDetail(data, this.logMessageContent) +
                            ".");
        ...
        var HttpConnection_1 = createCommonjsModule(function(module, exports) {
            ...
            var HttpConnection = /** @class */ (function() {
                ...
                HttpConnection.prototype.start = function(transferFormat) {
                    ...
                    Utils.Arg.isIn(transferFormat, ITransport.TransferFormat, "transferFormat");
                    this.logger.log(ILogger.LogLevel.Debug,
                        "Starting connection with transfer format '" +
                        ITransport.TransferFormat[transferFormat] +
                        "'.");
                    if (this.connectionState !== 2 /* Disconnected */) {
                        return Promise.reject(
                            new Error("Cannot start a connection that is not in the 'Disconnected' state."));
                    }
                            ...
                            return tslib_1.__generator(this,
                                function(_a) {
                                    ...
                                    case 1:
                                        ...
                                        if (!(this.options.transport === ITransport.HttpTransportType.WebSockets))
                                            return [3 /*break*/, 3];
                                        // No need to add a connection ID in this case
                                        this.transport =
                                            this.constructTransport(ITransport.HttpTransportType.WebSockets);
                                    ...
                                    case 12:
                                        e_2 = _a.sent();
                                        this.logger.log(ILogger.LogLevel.Error,
                                            "Failed to start the connection: " + e_2);
                                        this.connectionState = 2 /* Disconnected */;
                                        this.transport = null;
                                        throw e_2;
                                    case 13:
                            ...
                            return tslib_1.__generator(this,
                                function(_b) {
                                    ...
                                    case 2:
                                        _b.trys.push([2, 4,, 5]);
                                        return [
                                            4 /*yield*/, this.httpClient.post(negotiateUrl,
                                                {
                                                    content: "",
                                                    headers: headers,
                                                })
                                    ...
                                    case 3:
                                        response = _b.sent();
                                        if (response.statusCode !== 200) {
                                            throw Error("Unexpected status code returned from negotiate " +
                                                response.statusCode);
                                        }
                                    ...
                                    case 4:
                                        e_3 = _b.sent();
                                        this.logger.log(ILogger.LogLevel.Error,
                                            "Failed to complete negotiation with the server: " + e_3);
                                        throw e_3;
                                    case 5:
                                        return [2 /*return*/];
                                    }
                ...
                HttpConnection.prototype.createTransport =
                    function(url, requestedTransport, negotiateResponse, requestedTransferFormat) {
                        return tslib_1.__awaiter(this,
                            void 0,
                            void 0,
                            function() {
                                ...
                                return tslib_1.__generator(this,
                                    function(_a) {
                                        ...
                                        case 0:
                                            ...
                                            return [
                                                4 /*yield*/, this.transport.connect(connectUrl, requestedTransferFormat)
                                            ];
                                        case 1:
                                            _a.sent();
                                            // only change the state if we were connecting to not overwrite
                                        ...
                                        case 3:
                                            ...
                                            this.connectionState = 0 /* Connecting */;
                                            transport = this.resolveTransport(endpoint,
                                                requestedTransport,
                                        ...
                                        case 7:
                                            ...
                                            this.logger.log(ILogger.LogLevel.Error,
                                                ...
                                                ITransport.HttpTransportType[transport] +
                                                "': " +
                                                ex_1);
                                            this.connectionState = 2 /* Disconnected */;
                ...
                HttpConnection.prototype.constructTransport = function(transport) {
                    ...
                    case ITransport.HttpTransportType.WebSockets:
                        return new WebSocketTransport_1.WebSocketTransport(this.accessTokenFactory,
                            this.logger,
                            this.options.logMessageContent);
                    case ITransport.HttpTransportType.ServerSentEvents:
                        return new ServerSentEventsTransport_1.ServerSentEventsTransport(this.httpClient,
                            this.accessTokenFactory,
                            this.logger,
                            this.options.logMessageContent);
                    case ITransport.HttpTransportType.LongPolling:
                        return new LongPollingTransport_1.LongPollingTransport(this.httpClient,
                            this.accessTokenFactory,
                            this.logger,
                            this.options.logMessageContent);
                    default:
                ...
                HttpConnection.prototype.resolveTransport =
                    function(endpoint, requestedTransport, requestedTransferFormat) {
                        ...
                        if (transport === null || transport === undefined) {
                            ...
                            if (transportMatches(requestedTransport, transport)) {
                                if (transferFormats.indexOf(requestedTransferFormat) >= 0) {
                                    if ((transport === ITransport.HttpTransportType.WebSockets &&
                                            typeof WebSocket === "undefined") ||
                                        (transport === ITransport.HttpTransportType.ServerSentEvents &&
                                        ...
                                        this.logger.log(ILogger.LogLevel.Debug,
                                            "Selecting transport '" + ITransport.HttpTransportType[transport] + "'");
                                        return transport;
                                    }
                                } else {
                                    this.logger.log(ILogger.LogLevel.Debug,
                                        ...
                                        ITransport.TransferFormat[requestedTransferFormat] +
                                        "'.");
                                }
                            } else {
                                this.logger.log(ILogger.LogLevel.Debug,
                ...
                JsonHubProtocol.prototype.parseMessages = function(input, logger) {
                    ...
                    for (var _i = 0, messages_1 = messages; _i < messages_1.length; _i++) {
                        ...
                        default:
                            ...
                            logger.log(ILogger.LogLevel.Information,
...
/** A builder for configuring {@link HubConnection} instances. */
            var HubConnectionBuilder = /** @class */ (function() {
                ...
                HubConnectionBuilder.prototype.build = function() {
                    ...
                    return HubConnection_1.HubConnection.create(connection,
                        this.logger || Loggers.NullLogger.instance,
